...
# Called by an external cron (e.g. cron-job.org) at 08:00 Asia/Bangkok,
...
📌 ทุกวัน 08:00 ผมจะส่งสรุปข่าว AI ให้อัตโนมัติครับ"""
...
PERSONA_PROMPT = (
    ...
    "ตอบให้กระชับ ตรงประเด็น ไม่พูดวกวนหรือใส่รายละเอียดเกินจำเป็น แต่ต้องครบถ้วนไม่ตัดสาระสำคัญทิ้ง "
    'ถ้าเนื้อหาเป็นรายการหรือหลายข้อ ให้จัดเป็น bullet โดยขึ้นต้นแต่ละบรรทัดด้วย "•" เพื่อให้อ่านง่าย '
    "ห้ามใช้ Markdown เช่น **ตัวหนา** หรือ ## หัวข้อ เพราะ LINE ไม่รองรับการแสดงผล Markdown "
...
เลือกข่าวที่สำคัญและน่าสนใจที่สุดแค่ 3 ข่าว ไม่ต้องเยอะ จะเป็นข่าวไทยล้วน หรือผสมข่าวไทยกับต่างประเทศก็ได้ เลือกตามความน่าสนใจเป็นหลัก
